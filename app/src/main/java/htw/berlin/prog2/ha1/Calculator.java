...
public class Calculator {
     ...
     * der Bildschirminhalt mit dem Ergebnis aktualisiert. Falls eine Inversion von null versucht wird,
    ...
    public void pressUnaryOperationKey(String operation) {
        ...
        var result = switch (operation) {
            ...
            case "1/x" -> {
                if (latestValue == 0) {
                    yield Double.NaN; // Division durch 0 wird als "Error" behandelt
                } else {
    ...
    private boolean repeatLastOperation = false;

    public void pressEqualsKey() {
        if (latestOperation != null && !screen.isEmpty()) {
